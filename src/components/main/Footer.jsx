...
const Footer = () => {
  return (
    <footer className="footer pb-20 pt-14 lg:pb-6 lg:pt-8 px-3 md:px-4">
      <div className="waves">
      ...
      <div className="max-w-7xl mx-auto z-[999] flex flex-col md:flex-row  gap-8 lg:gap-96">
        <div>
          <Avatar />
          <div className="mt-3">
            <p className="text-gray-200 flex items-center gap-2 md:text-xl pl-1">
              <IoMailUnreadSharp /> mshakibalhasan21@gmail.com
            </p>
            <p className="text-gray-200 flex items-center gap-2 md:text-xl pl-1">
        ...
        <div>
          <h2 className="text-gray-200 text-2xl md:text-4xl font-bold flex items-center gap-2">
            <FaLink /> Social
          </h2>{" "}
          <div className="flex gap-7 mt-4 md:mt-6">
            <a href="https://web.facebook.com/profile.php?id=100092629614657">
              <button className="Btn h-[30px] md:h-[40px] w-[30px] md:w-[40px]">
      ...
      <p className="z-40 mt-10 md:mt-16 text-xs md:text-lg text-gray-300 text-center">
        &copy;2024 Md. Shakib Al Hasan | All Rights Reserved.
      </p>
    </footer>
  );
};
