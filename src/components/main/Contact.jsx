...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="h-full max-w-7xl mx-auto py-32 text-center lg:text-left z-50 px-3 overflow-hidden"
    >
      {/* text & form */}
      <div className=" flex flex-col md:flex-row items-center justify-center h-full gap-8">
        ...
        <div className="flex flex-col items-center md:items-start gap-2 md:gap-4">
          ...
          <p className="text-gray-200 max-w-sm text-center md:text-left">
        ...
        <motion.form
          ...
          animate="show"
          exit={"hidden"}
          className=" w-full md:w-[600px] space-y-4"
        >
